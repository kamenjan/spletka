    ...
    $(document).ready(function () {
        ...
        $('.SS_calendar').datepicker().on
                ('changeMonth', function (e) {
                    ...
                    $.post(base_url + controller + '/events_per_month/' + date, function (response) {
                        for (var day in response) {
                            if (response.hasOwnProperty(day)) {
                                var event = parseInt(JSON.stringify(response[day]).replace(/['"]+/g, ''));
        ...
        // JQuery AJAX function ($.ajax or $.post) - usese post to communicate with server
        ...
        $("#submit_btn").click(function () {
            ...
            // JQuery AJAX function ($.ajax or $.post) - usese post to communicate with server
            $.post(base_url + controller + '/update_survey', answer, function (response) {
